...
const { addItemToBasket, decrementItemFromBasket, removeItemFromBasket } =
  basketStore;
  ...
  <div class="basket-detail-card">
    ...
    <div class="basket-detail-card-description">
      <div>
        ...
        <p class="basket-detail-card-product-description">
          {{ product.description }}
        </p>
      </div>
    ...
    <div class="basket-detail-actions">
      <div class="basket-detail-actions-quantity">
        <v-btn density="compact" @click="decrementItemFromBasket(product)"
          >-</v-btn
        >
        {{ quantity }}
      ...
      <v-btn
        variant="outlined"
        color="#BC314A"
        @click="removeItemFromBasket(product)"
        >Supprimer</v-btn
      >
    </div>
  </div>
